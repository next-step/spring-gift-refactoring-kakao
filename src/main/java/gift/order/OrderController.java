...
public class OrderController {
    ...
    @GetMapping
    public ResponseEntity<Page<OrderResponse>> getOrders(@AuthMember Member member, Pageable pageable) {
        final Page<OrderResponse> orders =
                orderService.getOrders(member.getId(), pageable).map(OrderResponse::from);
