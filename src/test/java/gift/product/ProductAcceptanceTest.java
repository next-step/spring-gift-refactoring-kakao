...
class ProductAcceptanceTest {
  ...
  class GetProduct {
    ...
    void success() {
      // Given
      Product product =
          productRepository.save(new Product("테스트 상품", 5000, "http://img.com", category));
    ...
    void fail_notFound() {
      RestAssured.given().when().get("/api/products/999999").then().statusCode(404);
    }
  }
  ...
  class UpdateProduct {
    ...
    void success() {
      // Given
      Product product =
          productRepository.save(new Product("기존 상품", 5000, "http://old.com", category));
  ...
  class DeleteProduct {
    ...
    void success() {
      // Given
      Product product =
          productRepository.save(new Product("삭제할 상품", 5000, "http://img.com", category));

      // When & Then
      RestAssured.given().when().delete("/api/products/" + product.getId()).then().statusCode(204);
    }
  }
}
