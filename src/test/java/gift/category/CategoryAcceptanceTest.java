...
class CategoryAcceptanceTest {
  ...
  class UpdateCategory {
    ...
    void success() {
      // Given
      Category category =
          categoryRepository.save(new Category("기존", "#000", "http://old.com", "기존 설명"));
  ...
  class DeleteCategory {
    ...
    void success() {
      // Given
      Category category =
          categoryRepository.save(new Category("삭제할 카테고리", "#000", "http://img.com", "설명"));
    ...
    void success_notFound() {
      RestAssured.given().when().delete("/api/categories/999999").then().statusCode(204);
    }
  }
}
