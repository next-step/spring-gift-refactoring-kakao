...
9. 프로그래밍 요구 사항 추가
10. 기능 요구 사항 추가
11. 각 기능 요구 사항에 맞게 skill 만들기
12. CLAUDE.md에 API 명세서 추가 
13. TDD 루프를 유지하며 기능 요구 사항 진행하기
...
- [x] 여러 저장 작업이 하나의 논리 작업이라면, 중간 실패에서 부분 반영이 발생하지 않도록 경계를 설정한다.

### 5단계: 누락된 작동 구현

- [x] 기존 코드에 의도가 남아 있었지만 구현되지 않은 작동을 완료한다.
- [x] 새로운 작동은 반드시 테스트 또는 검증 가능한 증거로 확인한다.

### 6단계: 도메인 책임 되찾기

- [x] 작동을 유지하면서도 책임과 계산, 판단을 올바른 위치로 이동해 누수와 중복을 줄인다.
- [x] 변경 전후가 분명한 개선을 최소 2개 이상 수행한다.
